...
from torch2trt.examples.layers.quant_conv import QuantConv2d as quantconv2d
from torch2trt.examples.layers.quant_linear import QuantLinear as quantlinear
